...
<html>
    ...
    <body>
        <header class="main-header">
            <ul class="nav-links">
                ...
                <c:if test="${not empty sessionScope.loggedManager}">
                    <li><a href="managerHome.jsp">CineMan Dashboard: Revenue Statistic</a></li>
                    </c:if>
            </ul>
        ...
        <div class="container">
            ...
            <div class="menu">
                <button type="button" class="btn" onclick="toggleSubmenu()">View statistic by movie</button>
                ...
                <form action="CustomerStatisticPageServlet" method="get">
                    <button type="submit" class="btn">View statistic by customer</button>
                </form>

                <form action="RevenueStatisticPageServlet" method="get">
                    <button type="submit" class="btn">View statistic by revenue</button>
                </form>
            </div>
        </div>
